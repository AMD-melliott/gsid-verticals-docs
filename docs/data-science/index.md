# AMD Data Science Toolkit

Unlock the future of data science with the [AMD Data Science Toolkit](https://rocm.docs.amd.com/projects/rocm-ds/en/latest/index.html), an innovative open-source toolkit built on
the powerful ROCm platform. Tap into the unparalleled speed and efficiency of AMD Instinct™ GPUs, as AMD Data Science provides you
...
With AMD Data Science you have access to a rapidly expanding set of tools, empowering you to build, manage, and run entire data science
...
Behind AMD Data Science lies a passionate, driven team dedicated to continuously expanding and improving this toolkit, ensuring you
...
and unleash new possibilities with AMD Data Science.
...
<a class="id-card" href="hipMM.html">
  ...
  <span class="id-card-desc">Advanced memory management utilities for the various AMD Data Science libraries.</span>
  <span class="id-card-go" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></span>
</a>
...
<a class="id-card" href="hipRAFT.html">
  ...
  <span class="id-card-desc">Fundamental algorithms and primitives used by the various AMD Data Science libraries.</span>
  <span class="id-card-go" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></span>
</a>
...
<a class="id-card" href="https://github.com/rocm-ds">
  ...
  <span class="id-card-desc">View the source code for all AMD Data Science components on Github.</span>
  <span class="id-card-go" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></span>
</a>
...
<a class="id-card" href="https://rocm.docs.amd.com/projects/rocm-ds/en/latest/index.html">
  ...
  <span class="id-card-desc">View the latest AMD Data Science documentation, including installation instructions and API reference guides, on ROCm Docs.</span>
  <span class="id-card-go" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg></span>
</a>
...
<a class="id-card" href="ROCmDS-Blogs.html">
  ...
  <span class="id-card-title">AMD Data Science Blogs</span>
